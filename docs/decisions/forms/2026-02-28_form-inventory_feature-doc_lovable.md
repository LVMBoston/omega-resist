# Form Inventory — All Data-Collection Forms
...
Complete inventory of every data-collection form in the application, organized by sidebar navigation section, with all fields listed per form.
