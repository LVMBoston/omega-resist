-- Create optimized function to get campaign stats in a single call
CREATE OR REPLACE FUNCTION public.get_campaign_stats(campaign_codes text[])
RETURNS TABLE(
  campaign_code text,
  earliest_active timestamptz,
  latest_active timestamptz,
  real_data_rows bigint,
  sim_data_rows bigint,
  l0_count bigint,
  l1_count bigint,
  l2_count bigint,
  l3_plus_count bigint
)
LANGUAGE sql
STABLE
SECURITY DEFINER
