-- Update utm_id from 'ma-nkd25-02' to 'nk-pst'

UPDATE events_actions SET utm_id = 'nk-pst' WHERE utm_id = 'ma-nkd25-02';

UPDATE tokens SET utm_id = 'nk-pst' WHERE utm_id = 'ma-nkd25-02';

UPDATE tokens
SET full_url = format(
  'https://omega-resist.lovable.app/deck/%s?utm_campaign=%s&utm_id=%s&utm_source=%s&utm_medium=%s%s&t=%s%s&v_lvl=%s',
  deck_slug, utm_campaign, 'nk-pst', utm_source, utm_medium,
